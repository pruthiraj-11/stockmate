    ...
    <>
          ...
          <div className="flex-none lg:flex-initial">
            <Link to={"/"} className="flex align-middle justify-center ">
              <img
                ...
                alt="Float UI logo"
              />
              <h2 className="text-3xl font-bold ml-1 text-gray-900 my-auto ">
                StockMate
              </h2>
            </Link>
          </div>
      ...
      <div className="flex">
        <div className="flex h-screen flex-col hidden lg:block  justify-between border-r bg-white">
          <div className="px-3 w-52 py-6">
            <nav aria-label="Main Nav" className=" flex flex-col space-y-1">
              <Link
                to={"/inventory"}
                className={`flex items-center gap-2 rounded-lg bg-gray-100 px-4 py-2 text-gray-700 hover:bg-blue-100 hover:text-blue-700 ${
              ...
              <Link
                ...
                onClick={() => setActiveLink("purchase")}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 opacity-75"
              ...
              <Link
                to={"/managestores"}
                className={`flex items-center gap-2 rounded-lg bg-gray-100 px-4 py-2 text-gray-700 hover:bg-blue-100 hover:text-blue-700 ${
                  activeLink === "managestores"
                    ? "bg-blue-200 text-blue-700"
                    : "bg-gray-100 text-gray-700"
                }`}
                onClick={() => setActiveLink("managestores")}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 opacity-75"
                ...
                <span className="text-lg font-medium"> Stores </span>
              </Link>
            </nav>
          </div>
            ...
            >
              ...
              <div>
                <p class="text-xs">
                  ...
                  <span> {authLocal.user.email}</span>
                </p>
              </div>
            </a>
          </div> */}
        ...
        <div className="mx-auto p-3 w-full bg-gray-100">
          <Outlet />
        </div>
      </div>
    </>
