...
export default function Dashboard() {
  return (
    <>
              ...
              <div className="flex h-16 items-center justify-between">
                ...
                <div className="hidden md:block">
                  <div className="ml-4 flex items-center md:ml-6">
                    <button
                      type="button"
                      className="rounded-full bg-blue-800 p-1 text-blue-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-800"
                    >
      ...
      <div className="flex">
        <div className="flex-col h-screen p-3 hidden lg:block bg-white shadow w-60">
            ...
            <div className="flex-1">
              <ul className="pt-2 pb-4 space-y-1 text-sm">
                <li className="rounded-sm">
                  <Link
                    className="flex items-center p-2 space-x-3 rounded-md font-semibold text-blue-600"
                    to={"/"}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
